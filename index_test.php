...
for ($i = 0; $i < 12; $i +=1) {
	...
	if ($tiles[$i]['type'] == 'content') {
		...
		echo '<div id="tile' . ($i+1) . '" class="tile-inner">
					<a class="tile-link" href="' . $tiles[$i]['href'] . '">';
		
		echo '				<div class="tile-img">
							<img src="img/' . $tiles[$i]['img'] . '" />
						</div>';
	
		echo '			<div id="overlay' . ($i+1) . '" class="tile-overlay">
							<div class="tile-overlay-content">
								<img class="tile-icon" src="img/icon_tikko.png" />
								<h2>' . $tiles[$i]['title'] . '</h2>
		...
		echo '<div id="tile' . ($i+1) . '"  class="tile-social">
				<div class="tile-social-inner">
